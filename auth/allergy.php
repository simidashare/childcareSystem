                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="alle_code"
                                                    id="alle_code" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                                <label for="alle_description">Allergy Description:</label>
                                            </td>
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="alle_description"
                                                    id="alle_description" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="alle_symptoms"
                                                    id="alle_symptoms" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <div>
                                                    <input type="radio" name="alle_dth" value="Y" id="alle_dth_y" />
