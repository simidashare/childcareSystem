                        ...
                        <div>
                            <table class="table table-hover table-bordered">
                                ...
                                <tr scope="row">
                                    ...
                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="alle_code" id="alle_code_load"
                                            value="0"></select>
                                    </td>
                                </tr>
                                <tr scope="row" id="change_to" class="myHidden">
                                    ...
                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="alle_code" id="alle_code_load2"
                                            value="0"></select>
                                    </td>
                                </tr>
