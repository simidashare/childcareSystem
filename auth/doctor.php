...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav">
        <div class="container">
            ...
            font-weight-bold
            d-lg-none
          " href="#">Padstow Childcare Center</a>
    ...
    <section class="page-section clearfix">
        <div class="container">
            <div class="about-heading-content">
                <div class="row">
                    <div class="col">
                        <form class="table-responsive bg-faded rounded p-5" name="alleform" id="alleform">
                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_id" id="doc_id" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_fname"
                                                    id="doc_fname" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_lname"
                                                    id="doc_lname" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_street"
                                                    id="doc_street" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_suburb"
                                                    id="doc_suburb" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_state"
                                                    id="doc_state" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_postCode"
                                                    id="doc_postCode" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="doc_phone"
                                                    id="doc_phone" />
                                            </td>
                                        </tr>
                                    </table>
