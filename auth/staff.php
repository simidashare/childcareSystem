    ...
    <section class="page-section clearfix">
        <div class="container">
            <div class="about-heading-content">
                <div class="row">
                    <div class="col">
                        <form class="table-responsive bg-faded rounded p-5" name="staff" action="./staff-process.php"
                            method="post">
                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="staff_fname"
                                                    id="staff_fname" value>
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <!-- <td > -->
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="staff_lname"
                                                    id="staff_lname" value>
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <div>
                                                    <input type="radio" name="staff_gender" id="staff_gender_m"
                                                        value="M">
                                                    <label for="staff_gender_m">Male: <br></label>

                                                    <input type="radio" name="staff_gender" id="staff_gender_f"
                                                        value="F">
                                                    <label for="staff_gender_f">Female: <br></label>

                                                    <input type="radio" name="staff_gender" id="staff_gender_o"
                                                        value="O">
                                        ...
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="staff_homePhone"
                                                    id="staff_homePhone" value>
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="staff_workPhone"
                                                    id="staff_workPhone" value>
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="staff_mobile"
                                                    id="staff_mobile" value>
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="registration_key"
                                                    id="registration_key" value>
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <div>
                                                    <input class="checkbox-margin" type="checkbox" name="on_duty"
                                                        id="monday" value="1">
