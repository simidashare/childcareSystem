                    ...
                    <div class="table-responsive">
                        ...
                        <div>
                            <table class="table table-hover table-bordered">
                                ...
                                <tr scope="row">
                                    ...
                                    <td class="align-middle table-info">
                                        <select class="custom-input" type="text" name="family_id"
                                            id="family_id_load"></select>
                                    </td>
                                </tr>
                                <tr scope="row">
                                    ...
                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="doc_id" id="doc_id_load"
                                            value="0"></select>
                                    </td>
                                </tr>
                                <tr scope="row" id="change_to" class="myHidden">
                                    ...
                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="doc_id" id="doc_id_load2"
                                            value></select>
                                    </td>
                                </tr>
                            ...
                            <div class="col-auto ml-auto btn-group flex-wrap btn-group-justified" style="width:100%">
                                ...
                                <td class="btn-group"><button class="btn btn-primary mb-2" id="remove">Delete</button>
                                </td>
                                <td class="btn-group"><button class="btn btn-primary mb-2" id="update">Update</button>
                                </td>
                                <td class="btn-group"><button class="btn btn-primary mb-2 myHidden"
                                        id="confirm_update">Confirm Update</button></td>
                                <td class="btn-group"><button class="btn btn-primary mb-2" id="search">Search</button>
                                </td>
                                <td class="btn-group"><button class="btn btn-primary mb-2" id="viewAll">ViewAll</button>
                                </td>
                            </div>
                            <div>
