                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="med_id" id="med_id" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="med_name" id="med_name" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="med_dosage"
                                                    id="med_dosage" />
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="med_description"
                                                    id="med_description" />
                                            </td>
                                        </tr>
                                    </table>
